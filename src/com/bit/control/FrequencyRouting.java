...
public class FrequencyRouting 
{
	ArrayList<Couple> coupleList = new ArrayList<Couple>();
	ArrayList<Contact> contactList = new ArrayList<Contact>();

	public FrequencyRouting(int test_startTime, int test_endTime)//初始化messageList和contactList
	{
	...
	{	
		...
		System.out.println("\nFrequencyRouting---第"+(i+1)+"次测试总数:"+Main.coupleArray[i]);
		...
		if(i==9)
		{
			RoutingPerformanceFrame frame = new RoutingPerformanceFrame(Main.load, "Frequency Routing", Main.successArray[i],
